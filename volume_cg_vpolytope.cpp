                 ...
                 double const& exact)
{
    ...
    // test_values(volume, expectedBall, exact, "cooling_gaussians_normal");
    ...
    NT volume_HMC = volume_cooling_gaussians_HMC<GaussianHamiltonianMonteCarloExactWalk, RNGType>(P2, e, walk_len);
