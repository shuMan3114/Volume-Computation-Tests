...
#include "/workspaces/Volume-Computation-Tests/volume_cooling_gaussians_HMC.hpp"
...
template <typename NT>
void test_values(NT volume, NT expected, NT exact, std::string method)
{
                 ...
                 bool birk = false)
{
    ...
    //     // test_values(volume, expectedBall, exact, "cooling_gaussains");

    //     volume_HMC = volume_cooling_gaussians_HMC<GaussianHamiltonianMonteCarloExactWalk, RNGType>(HP, e, walk_len);
    //     test_values(volume_HMC, expectedBall, exact, "cooling_gaussains_HMC");
    // }

    // volume = volume_cooling_gaussians<GaussianCDHRWalk, RNGType>(HP, e, walk_len);
    // test_values(volume, expectedCDHR, exact, "cooling_gaussains");
    ...
    // test_values(volume, expectedRDHR, exact, "cooling_gaussians");
